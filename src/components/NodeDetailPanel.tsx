    ...
    <AnimatePresence>
      {node && (
        <motion.div
          ...
          className="fixed right-6 top-6 bottom-6 w-96 z-50 hidden lg:block"
        >
          <Card className="h-full flex flex-col shadow-2xl border-2" style={{ borderColor: node.color }}>
            <div className="p-6 flex-1 overflow-auto">
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <h2 className="text-2xl font-semibold mb-1" style={{ color: node.color }}>
